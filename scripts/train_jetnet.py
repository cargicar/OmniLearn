...
def parse_arguments():
    ...
    parser.add_argument("--folder", type=str, default="../../datasets/JetClass/Pythia/train_100M/train/", help="Folder containing input files")
...
def get_data_loader(flags):
    ...
    elif flags.dataset == 'jetnet0':
        train = utils.JetNetDataLoader(os.path.join(flags.folder,'JetClass_0.h5'), flags.batch, hvd.rank(), hvd.size())
        val = utils.JetNetDataLoader(os.path.join(flags.folder, 'JetClass_0.h5'), flags.batch, hvd.rank(), hvd.size())
